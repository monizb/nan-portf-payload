...
INSERT INTO site_settings VALUES(1,'Nanditha C P','The best design I have ever seen was not made by a human','Product Designer, Rocketium',NULL,'Designed by a human. Inspired by everything else.','This is what I build when no one tells me what to build','Designer • Thinker',unistr('I design products. I think in systems.\u000aEverything else you will have to watch.'),NULL,'Design is too important to keep to myself.',9,10,unistr('80% of what you build will never be used.\u000aWhy engineers need to understand design.'),'The best work happens when two people in the room refuse to settle.','contact@nandithacp.com','/Sprint.glb','2026-03-23T18:44:04.587Z','2026-03-23T16:37:43.252Z');
